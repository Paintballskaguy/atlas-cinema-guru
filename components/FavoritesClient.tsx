...
// This component handles the client-side data fetching, state, and UI.
  ...
  const fetchFavorites = useCallback(async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Assuming the API returns { favorites: Movie[] }
  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-white/70 text-sm mt-2">Current Page: {page}</p>
      </div>
